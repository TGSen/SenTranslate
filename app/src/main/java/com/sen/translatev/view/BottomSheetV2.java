package com.sen.translatev.view;
...
public class BottomSheet extends Dialog implements DialogInterface {
    ...
    private com.cocosw.bottomsheet.BottomSheet.Builder builder;
    ...
    private void init(final Context context) {
        ...
        mDialogView.setSlideListener(new ClosableSlidingLayout.SlideListener() {
            ...
            public void onClosed() {
                com.cocosw.bottomsheet.BottomSheet.this.dismiss();
            }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!((ActionMenuItem) adapter.getItem(position)).invoke()) {
                    if (builder.menulistener != null)
                        ...
                        builder.listener.onClick(com.cocosw.bottomsheet.BottomSheet.this, ((MenuItem) adapter.getItem(position)).getItemId());
                }
                dismiss();
            }
        });
    ...
    public static class Builder {
         ...
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder sheet(@MenuRes int xmlRes) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder sheet(int id, @DrawableRes int iconRes, @StringRes int textRes) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder sheet(int id, @NonNull Drawable icon, @NonNull CharSequence text) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder sheet(int id, @StringRes int textRes) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder sheet(int id, @NonNull CharSequence text) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder title(@StringRes int titleRes) {
         ...
         */
        @Deprecated
        public com.cocosw.bottomsheet.BottomSheet.Builder remove(int id) {
            menu.removeItem(id);
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder icon(Drawable icon) {
            this.icon = icon;
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder icon(@DrawableRes int iconRes) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder listener(@NonNull OnClickListener listener) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder listener(@NonNull MenuItem.OnMenuItemClickListener listener) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder darkTheme() {
         ...
         */
        public com.cocosw.bottomsheet.BottomSheet show() {
            com.cocosw.bottomsheet.BottomSheet dialog = build();
            dialog.show();
            return dialog;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder grid() {
            this.grid = true;
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder limit(@IntegerRes int limitRes) {
        ...
        public com.cocosw.bottomsheet.BottomSheet build() {
            com.cocosw.bottomsheet.BottomSheet dialog = new com.cocosw.bottomsheet.BottomSheet(context, theme);
            dialog.builder = this;
            return dialog;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder title(CharSequence title) {
            this.title = title;
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public com.cocosw.bottomsheet.BottomSheet.Builder setOnDismissListener(@NonNull OnDismissListener listener) {
            this.dismissListener = listener;
            return this;
        }
    }
