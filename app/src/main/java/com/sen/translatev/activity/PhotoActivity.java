        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_SERIVCE_CONNECTED:
                    ...
                    Toast.makeText(PhotoActivity.this, "bind success", Toast.LENGTH_SHORT).show();
                    tsr = new TxtImageSuperResolution(PhotoActivity.this);
                    break;
                case MSG_SERIVCE_DISCONNECTED:
                    Toast.makeText(PhotoActivity.this, "disconnect", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if ((requestCode == REQUEST_IMAGE_CAPTURE || requestCode == REQUEST_IMAGE_SELECT) && resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_IMAGE_CAPTURE) {
                ...
                Cursor cursor = PhotoActivity.this.getContentResolver().query(selectedImage, filePathColumn, null, null, null);
                cursor.moveToFirst();
