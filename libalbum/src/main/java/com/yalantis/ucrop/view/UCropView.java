...
import com.yalantis.ucrop.SaveParameter;
...
//    }
    public void resetCropImageView(SaveParameter saveParameter) {
        if (saveParameter != null && saveParameter.imageMatrix != null && saveParameter.overLayerRectf != null) {
            mGestureCropImageView.setCropRect(saveParameter.overLayerRectf);
            invalidate();
        }
