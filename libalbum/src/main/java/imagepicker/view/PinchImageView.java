...
public class PinchImageView extends AppCompatImageView {
     ...
     * 允许双击
     */
    private boolean enableDouable = true;
    ...
    public void canDouableDownScale(boolean isCan) {
        this.enableDouable = isCan;
    }
    ...
    private GestureDetector mGestureDetector = new GestureDetector(PinchImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if (enableDouable && mPinchMode == PINCH_MODE_SCROLL && !(mScaleAnimator != null && mScaleAnimator.isRunning())) {
