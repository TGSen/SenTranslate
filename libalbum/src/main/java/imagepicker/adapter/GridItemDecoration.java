...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param layoutManager
     */
    public GridItemDecoration(int leftRight, int topBottom, int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public GridItemDecoration(int space, boolean includeEdge, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public GridItemDecoration(int space, int headItemCount, boolean includeEdge, @LayoutManager int layoutManager) {
        this.space = space;
        this.headItemCount = headItemCount;
     ...
     * @param layoutManager
     */
    public GridItemDecoration(int space, int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public GridItemDecoration(int space, @LayoutManager int layoutManager) {
