...
public class RemoteTranslateActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstance) {
        ...
        try {
            ...
            Log.e("Harrison",srcLanguage);
            Log.e("Harrison",dstLanguage);
        } catch (RuntimeException e) {
            SmartLog.e("Harrison", "Get intent value failed:" + e.getMessage());
        }
        ...
        if (this.isChosen(this.originBitmap)) {
            ...
            task.addOnSuccessListener(new OnSuccessListener<MLText>() {
                ...
                public void onFailure(Exception e) {
                    ...
                    Log.e("Harrison","onFailure fail "+e.getLocalizedMessage());
                    RemoteTranslateActivity.this.displayFailure();
                    return;
                }
            });
    ...
    private void loadOriginImage() {
        ...
        Log.e("Harrison",this.imageUri.getPath());
        ...
        SmartLog.i("Harrison", "resized image size width:" + this.originBitmap.getWidth() + ",height: " + this.originBitmap.getHeight());
        this.preview.setImageBitmap(this.originBitmap);
    }
    ...
    private Pair<Integer, Integer> getTargetSize() {
        ...
        SmartLog.i("Harrison", "height:" + targetHeight + ",width:" + targetWidth);
    ...
    public void onDestroy() {
        ...
        if (this.textAnalyzer != null) {
            try {
                ...
                SmartLog.e("Harrison", "Stop analyzer failed: " + e.getMessage());
            }
        }
